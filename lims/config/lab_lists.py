...
prepsheet_columns = {
    ...
    "Metals (AF)": ['Sample ID', 'Aliquot', 'Aliquot Units', "Filtered (y/n)", 'Analysis Date', 'Analysis Time', 'Analyst'],
    "Metals (AQ)": ['Sample ID', 'Aliquot', 'Aliquot Units', "Filtered (y/n)", 'Analysis Date', 'Analysis Time', 'Analyst'],
    "Metals (SM)": ['Sample ID', 'Aliquot', 'Aliquot Units', "Filtered (y/n)", 'Analysis Date', 'Analysis Time', 'Analyst'],
    "Metals (SO)": ['Sample ID', 'Aliquot', 'Aliquot Units', "Filtered (y/n)", 'Analysis Date', 'Analysis Time', 'Analyst'],
...
excel_template_field_locations = {
    ...
    "Metals (AF).xlsx": {"BatchID":"B3", "SampleID":"A8"},
    "Metals (AQ).xlsx": {"BatchID":"B3", "SampleID":"A8"},
    "Metals (SM).xlsx": {"BatchID":"B3", "SampleID":"A8"},
    "Metals (SO).xlsx": {"BatchID":"B3", "SampleID":"A8"},
...
methods_qc = {"FIMS": ['BLK', 'LCS', 'DUP'],
                ...
                "Metals (AF)": ['BLK', 'LCS', 'LCSDUP'],
                "Metals (AQ)": ['BLK', 'LCS', 'MS', 'MSDUP'],
                "Metals (SM)": ['BLK', 'LCS', 'LCSDUP'],
                "Metals (SO)": ['BLK', 'LCS', 'DUP', 'MS'],
...
methods_codes_dict = {
    ...
    "Metals (SO)": {"ANMCode": "6020B", "EXCode": "SL035"},
    "Metals (AQ)": {"ANMCode": "6020B", "EXCode": "SL036"},
    "Metals (SM)": {"ANMCode": "6020B", "EXCode": "SL037"},
    "Metals (AF)": {"ANMCode": "6020B", "EXCode": "SL037"},
    'TCLP': {},
