...
excel_template_field_locations = {
    ...
    "Metals (Air Filter).xlsx": {"BatchID":"B3", "SampleID":"A8"},
    "Metals (Aqueous).xlsx": {"BatchID":"B3", "SampleID":"A8"},
    "Metals (Smear).xlsx": {"BatchID":"B3", "SampleID":"A8"},
    "Metals (Soil).xlsx": {"BatchID":"B3", "SampleID":"A8"},
